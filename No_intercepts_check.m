...
nx_max = [30]; % Max number of intercepts to try. Must be multiple of 10. Suggested starting value, 30 or 40
...
phase = 'Quartz'; % Phase to measure. Must match a phase present in CS.
crystal = '-3m1'; % Crystal system of phase to measure. 
